...
export const metadata: Metadata = {
  title: "Compendium Rights",
  description:
    "License Turner Biographies / The Greatest Humans for compendium — Single-title compendium $175 or Catalog compendium slate $650. Direct inquiry by email.",
  openGraph: {
    title: "Compendium Rights — Turner Biographies",
    description: "Single-title compendium $175 · Catalog compendium slate $650.",
    type: "website",
  },
};
...
const packages = [
  {
    tag: "Title",
    title: "Single-title compendium",
    price: "$175",
    detail:
      "Rights to license one Firebrand / Greatest Humans title as a compendium — territory, term, and exclusivity set in the agreement.",
    href: "mailto:brad@treadcompanies.com?subject=Compendium%20rights%20single-title%20%24175&body=I%20want%20Single-title%20compendium%20rights%20(%24175).%0A%0ATitle%3A%0AFormat%20%2F%20modules%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License title — $175",
  },
  {
    tag: "Slate",
    title: "Catalog compendium slate",
    price: "$650",
    detail:
      "Multi-title or multi-issue compendium slate across Firebrand / Greatest Humans — one agreement for a broader compendium slate.",
    href: "mailto:brad@treadcompanies.com?subject=Compendium%20rights%20catalog%20slate%20%24650&body=I%20want%20Catalog%20compendium%20slate%20rights%20(%24650).%0A%0ATitles%20%2F%20slate%3A%0AModules%20planned%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License slate — $650",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_82%_10%,rgba(154,52,44,0.28),transparent_45%),linear-gradient(180deg,#1c222b,#12151a)]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          ...
          <p className="mt-5 max-w-xl text-lg text-bone/80">
            Run and slate compendium licensing for Firebrand and The Greatest Humans —
      ...
      <section className="bg-[#0e1116]">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-14 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            ...
            <p className="mt-2 max-w-xl text-bone/70">Compendium covers reference compendium packs. Codex covers classroom codex packs.</p>
          </div>
          <Link href="/codex" className="inline-flex border border-bone/30 px-5 py-3 font-[family-name:var(--font-ui)] text-sm uppercase tracking-[0.16em] hover:border-brass hover:text-brass">Codex
          </Link>
        </div>
      </section>
    </div>
