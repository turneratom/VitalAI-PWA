...
export const metadata: Metadata = {
  title: "Pass Rights",
  description:
    "License Turner Biographies / The Greatest Humans for pass — Single-title pass $1 or Multi-title pass slate $1. Direct inquiry by email.",
  openGraph: {
    title: "Pass Rights — Turner Biographies",
    description: "Single-title pass $1 · Multi-title pass slate $1.",
    type: "website",
  },
};
...
const packages = [
  {
    pass: "Title",
    title: "Single-title pass",
    price: "$1",
    detail:
      "Rights to license one Firebrand / Greatest Humans title as a pass — territory, term, and exclusivity set in the agreement.",
    href: "mailto:brad@treadcompanies.com?subject=Pass%20rights%20single-title%20%241&body=I%20want%20Single-title%20pass%20rights%20(%241).%0A%0ATitle%3A%0AFormat%20%2F%20modules%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License title — $1",
  },
  {
    pass: "Slate",
    title: "Multi-title pass slate",
    price: "$1",
    detail:
      "Multi-title or multi-issue pass slate across Firebrand / Greatest Humans — one agreement for a broader pass slate.",
    href: "mailto:brad@treadcompanies.com?subject=Pass%20rights%20catalog%20slate%20%241&body=I%20want%20Catalog%20pass%20slate%20rights%20(%241).%0A%0ATitles%20%2F%20slate%3A%0AModules%20planned%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License slate — $1",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_82%_10%,rgba(154,52,44,0.28),transparent_45%),linear-gradient(180deg,#1c222b,#12151a)]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          ...
          <p className="mt-5 max-w-xl text-lg text-bone/80">
            Run and slate pass licensing for Firebrand and The Greatest Humans —
          ...
          <div className="mt-12 grid gap-0 border-t border-white/15 md:grid-cols-2">
            {packages.map((pkg) => (
              <article key={pkg.title} className="flex flex-col border-b border-white/15 p-8 md:border-r md:border-b-0 md:odd:border-r md:[&:nth-child(2n)]:border-r-0">
                <p className="font-[family-name:var(--font-ui)] text-xs uppercase tracking-[0.22em] text-brass">{pkg.pass}</p>
      ...
      <section className="bg-[#0e1116]">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-14 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            ...
            <p className="mt-2 max-w-xl text-bone/70">Pass covers reference pass packs. Codex covers classroom codex packs.</p>
          </div>
