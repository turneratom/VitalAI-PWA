...
export const metadata: Metadata = {
  title: "Bookmark Rights",
  description:
    "License Turner Biographies / The Greatest Humans for bookmark — Single-title bookmark $1,000 or Catalog bookmark slate $3,000. Direct inquiry by email.",
  openGraph: {
    title: "Bookmark Rights — Turner Biographies",
    description: "Single-title bookmark $1,000 · Catalog bookmark slate $3,000.",
    type: "website",
  },
};
...
const packages = [
  {
    tag: "Title",
    title: "Single-title bookmark",
    price: "$1,000",
    detail:
      "Rights to license one Firebrand / Greatest Humans title as a bookmark — territory, term, and exclusivity set in the agreement.",
    href: "mailto:brad@treadcompanies.com?subject=Bookmark%20rights%20single-title%20%241%2C000&body=I%20want%20Single-title%20bookmark%20rights%20(%241%2C000).%0A%0ATitle%3A%0AFormat%20%2F%20modules%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License title — $1,000",
  },
  {
    tag: "Slate",
    title: "Catalog bookmark slate",
    price: "$3,000",
    detail:
      "Multi-title or multi-issue bookmark slate across Firebrand / Greatest Humans — one agreement for a broader bookmark slate.",
    href: "mailto:brad@treadcompanies.com?subject=Bookmark%20rights%20catalog%20slate%20%243%2C000&body=I%20want%20Catalog%20bookmark%20slate%20rights%20(%243%2C000).%0A%0ATitles%20%2F%20slate%3A%0AModules%20planned%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License slate — $3,000",
  },
];
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_82%_10%,rgba(154,52,44,0.28),transparent_45%),linear-gradient(180deg,#1c222b,#12151a)]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          ...
          <p className="mt-5 max-w-xl text-lg text-bone/80">
            Run and slate bookmark licensing for Firebrand and The Greatest Humans —
          ...
          <div className="mt-10 flex flex-wrap gap-3 font-[family-name:var(--font-ui)] text-sm">
            ...
            <Link href="/map" className="inline-flex border border-bone/30 px-5 py-3 font-[family-name:var(--font-ui)] text-sm uppercase tracking-[0.16em] hover:border-brass hover:text-brass">
              Map
            </Link>
            <Link href="/atlas" className="inline-flex border border-bone/30 px-5 py-3 font-[family-name:var(--font-ui)] text-sm uppercase tracking-[0.16em] hover:border-brass hover:text-brass">
              Atlas
            </Link>
            <Link href="/chronology" className="inline-flex border border-bone/30 px-5 py-3 font-[family-name:var(--font-ui)] text-sm uppercase tracking-[0.16em] hover:border-brass hover:text-brass">
              Chronology
            </Link>
      ...
      <section className="bg-[#0e1116]">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-14 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            ...
            <p className="mt-2 max-w-xl text-bone/70">Bookmark covers week-by-session plans. Classroom covers teacher packs.</p>
          </div>
