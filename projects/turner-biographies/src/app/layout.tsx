        ...
        <header className="relative z-20 border-b border-white/10 bg-ink/80 backdrop-blur-md">
          <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-6 px-5 py-4 md:px-8">
            ...
            <nav className="flex items-center gap-5 font-[family-name:var(--font-ui)] text-sm text-fog">
              ...
              <Link className="transition hover:text-bone" href="/pamphlet">
                Pamphlet
              </Link>
              <Link className="transition hover:text-bone" href="/handbill">
                Handbill
              </Link>
              <Link className="transition hover:text-bone" href="/circular">
                Circular
              </Link>
              ...
              <Link className="transition hover:text-bone" href="/playbill">
                Playbill
              </Link>
              <Link className="transition hover:text-bone" href="/program">
                Program
              </Link>
              <Link className="transition hover:text-bone" href="/booklet">
                Booklet
              </Link>
              <Link className="transition hover:text-bone" href="/tract">
                Tract
              </Link>
              <Link className="transition hover:text-bone" href="/zine">
                Zine
              </Link>
              <Link className="transition hover:text-bone" href="/chaplet">
                Chaplet
              </Link>
              <Link className="transition hover:text-bone" href="/broadside">
                Broadside
              </Link>
              ...
              <Link className="transition hover:text-bone" href="/leaf">
                Leaf
              </Link>
              <Link className="transition hover:text-bone" href="/billet">
                Billet
              </Link>
              <Link className="transition hover:text-bone" href="/card">
                Card
              </Link>
              <Link className="transition hover:text-bone" href="/slip">
                Slip
              </Link>
              <Link className="transition hover:text-bone" href="/ticket">
                Ticket
              </Link>
              <Link className="transition hover:text-bone" href="/stub">
                Stub
              </Link>
              <Link className="transition hover:text-bone" href="/chit">
                Chit
              </Link>
              <Link className="transition hover:text-bone" href="/tag">
                Tag
              </Link>
              <Link className="transition hover:text-bone" href="/pass">
                Pass
              </Link>
