...
export const metadata: Metadata = {
  title: "Syllabus Rights",
  description:
    "License Turner Biographies / The Greatest Humans for syllabus — Single-title syllabus $6,500 or Catalog syllabus slate $16,000. Direct inquiry by email.",
  openGraph: {
    title: "Syllabus Rights — Turner Biographies",
    description: "Single-title syllabus $6,500 · Catalog syllabus slate $16,000.",
    type: "website",
  },
};
...
const packages = [
  {
    tag: "Title",
    title: "Single-title syllabus",
    price: "$6,500",
    detail:
      "Rights to license one Firebrand / Greatest Humans title as a syllabus — territory, term, and exclusivity set in the agreement.",
    href: "mailto:brad@treadcompanies.com?subject=Syllabus%20rights%20single-title%20%246%2C500&body=I%20want%20Single-title%20syllabus%20rights%20(%246%2C500).%0A%0ATitle%3A%0AFormat%20%2F%20modules%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    cta: "License title — $6,500",
  },
  {
    tag: "Slate",
    title: "Catalog syllabus slate",
    price: "$16,000",
    detail:
      "Multi-title or multi-issue syllabus slate across Firebrand / Greatest Humans — one agreement for a broader syllabus slate.",
    href: "mailto:brad@treadcompanies.com?subject=Syllabus%20rights%20catalog%20slate%20%2416%2C000&body=I%20want%20Catalog%20syllabus%20slate%20rights%20(%2416%2C000).%0A%0ATitles%20%2F%20slate%3A%0AModules%20planned%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
    ...
    <div className="bg-ink text-bone">
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_82%_10%,rgba(154,52,44,0.28),transparent_45%),linear-gradient(180deg,#1c222b,#12151a)]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          ...
          <p className="mt-5 max-w-xl text-lg text-bone/80">
            Run and slate syllabus licensing for Firebrand and The Greatest Humans —
          ...
          <div className="mt-10 flex flex-wrap gap-3 font-[family-name:var(--font-ui)] text-sm">
            ...
            <Link href="/classroom" className="border border-bone/30 px-5 py-3 uppercase tracking-[0.16em] hover:border-brass hover:text-brass">
              Serialization
            </Link>
      ...
      <section className="bg-[#0e1116]">
        <div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-14 md:flex-row md:items-center md:justify-between md:px-8">
          <div>
            <h2 className="font-[family-name:var(--font-display)] text-2xl md:text-3xl">Need classroom instead?</h2>
            <p className="mt-2 max-w-xl text-bone/70">Syllabus covers week-by-week plans. Classroom covers teacher packs.</p>
          </div>
