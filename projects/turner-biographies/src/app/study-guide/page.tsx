...
const packages = [
  {
    ...
    href: "mailto:brad@treadcompanies.com?subject=Study%20guide%20rights%20single-title%20%246%2C500&body=I%20want%20Single-title%20study%20guide%20rights%20(%246%2C500).%0A%0ATitle%3A%0AAudience%20%2F%20level%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
  ...
  },
  {
    ...
    href: "mailto:brad@treadcompanies.com?subject=Study%20guide%20rights%20catalog%20slate%20%2417%2C000&body=I%20want%20Catalog%20study%20guide%20slate%20rights%20(%2417%2C000).%0A%0ATitles%20%2F%20slate%3A%0AAudience%20planned%3A%0AWindow%3A%0AName%3A%0AEmail%3A%0A",
      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_82%_10%,rgba(154,52,44,0.28),transparent_45%),linear-gradient(180deg,#1c222b,#12151a)]">
        <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-24">
          ...
          <div className="mt-10 flex flex-wrap gap-3 font-[family-name:var(--font-ui)] text-sm">
            ...
            <Link href="/workbook" className="border border-bone/30 px-5 py-3 uppercase tracking-[0.16em] hover:border-brass hover:text-brass">Workbook</Link>
