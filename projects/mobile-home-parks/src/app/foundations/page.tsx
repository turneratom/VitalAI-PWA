...
export const metadata: Metadata = {
  title: "Foundations Diligence Pack — $329 | Trailer Parks",
  description:
    "Foundations Diligence Pack: single park $329, or three-park pack $649. Foundations flag notes, variance gap list, lender-ready summary. Invoice by email.",
  openGraph: {
    title: "Foundations Diligence Pack — $329",
    description:
      "Single park $329 · Three-park pack $649. Foundations flag notes, variance gap list, lender-ready summary.",
    type: "website",
...
const SINGLE = `mailto:${email}?subject=${encodeURIComponent(
  "Foundations Diligence Pack — $329 single park"
)}&body=${encodeURIComponent(
  `I want a Foundations Diligence Pack ($329 single park).\n\nPark / market:\nSpaces / occupancy (if known):\nYour name:\nEmail:\nPhone (optional):\n\nPlease send invoice.`
)}`;

const PACK = `mailto:${email}?subject=${encodeURIComponent(
  "Foundations Diligence Pack Three-Park Pack — $649"
)}&body=${encodeURIComponent(
  `I want a Foundations Diligence Pack Three-Park Pack ($649).\n\nParks (up to 3):\nYour name:\nEmail:\nFirm (optional):\n\nPlease send invoice.`
)}`;

const perks = [
  {
    title: "Foundations flag notes",
    body: "Pier, slab, and compliance flags after reviewing the park’s foundations file and recent tests.",
  },
  {
    title: "Pier gap list",
    body: "Clear flags on pier mismatches, missing tests, and what a lender or buyer counsel may push back on.",
  },
  {
    title: "Foundations hygiene",
    body: "Line-item notes where foundations docs look soft, padded, or missing for IC review.",
  },
  {
    title: "PDF delivery",
    body: "One memo PDF per park — single park at $329, or three parks in a pack at $649.",
  },
];
    ...
    <main className="bg-background">
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Foundations Diligence Pack.
            <span className="mt-2 block text-accent">$329 · or $649.</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg font-light text-white/75">
            Single park at $329, or three-park pack at $649 — foundations flag notes,
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-bold text-navy md:text-4xl">
          Built for buyers and lenders who need a clean foundations picture before they argue price.
        </h2>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg font-light text-foreground/70">
            Single park $329 · Three-park pack $649. Pair with{" "}
