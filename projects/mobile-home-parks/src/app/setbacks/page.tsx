...
export const metadata: Metadata = {
  title: "Setbacks Diligence Pack — $369 | Trailer Parks",
  description:
    "Setbacks Diligence Pack: single park $369, or three-park pack $849. Setbacks flag notes, variance gap list, lender-ready summary. Invoice by email.",
  openGraph: {
    title: "Setbacks Diligence Pack — $369",
    description:
      "Single park $369 · Three-park pack $849. Setbacks flag notes, variance gap list, lender-ready summary.",
    type: "website",
...
const SINGLE = `mailto:${email}?subject=${encodeURIComponent(
  "Setbacks Diligence Pack — $369 single park"
)}&body=${encodeURIComponent(
  `I want a Setbacks Diligence Pack ($369 single park).\n\nPark / market:\nSpaces / occupancy (if known):\nYour name:\nEmail:\nPhone (optional):\n\nPlease send invoice.`
)}`;

const PACK = `mailto:${email}?subject=${encodeURIComponent(
  "Setbacks Diligence Pack Three-Park Pack — $849"
)}&body=${encodeURIComponent(
  `I want a Setbacks Diligence Pack Three-Park Pack ($849).\n\nParks (up to 3):\nYour name:\nEmail:\nFirm (optional):\n\nPlease send invoice.`
)}`;

const perks = [
  {
    title: "Setbacks flag notes",
    body: "Line, yard, and compliance flags after reviewing the park’s setbacks file and recent tests.",
  },
  {
    title: "Yard gap list",
    body: "Clear flags on yard mismatches, missing tests, and what a lender or buyer counsel may push back on.",
  },
  {
    title: "Setbacks hygiene",
    body: "Line-item notes where setbacks docs look soft, padded, or missing for IC review.",
  },
  {
    title: "PDF delivery",
    body: "One memo PDF per park — single park at $369, or three parks in a pack at $849.",
  },
];
    ...
    <main className="bg-background">
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Setbacks Diligence Pack.
            <span className="mt-2 block text-accent">$369 · or $849.</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg font-light text-white/75">
            Single park at $369, or three-park pack at $849 — setbacks flag notes,
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-bold text-navy md:text-4xl">
          Built for buyers and lenders who need a clean setbacks picture before they argue price.
        </h2>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg font-light text-foreground/70">
            Single park $369 · Three-park pack $849. Pair with{" "}
