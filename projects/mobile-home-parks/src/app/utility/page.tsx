...
export const metadata: Metadata = {
  title: "Utility Diligence Pack — $479 | Trailer Parks",
  description:
    "Utility Diligence Pack: single park $479, or three-park pack $1,249. Utility flag notes, variance gap list, lender-ready summary. Invoice by email.",
  openGraph: {
    title: "Utility Diligence Pack — $479",
    description:
      "Single park $479 · Three-park pack $1,249. Utility flag notes, variance gap list, lender-ready summary.",
    type: "website",
...
const SINGLE = `mailto:${email}?subject=${encodeURIComponent(
  "Utility Diligence Pack — $479 single park"
)}&body=${encodeURIComponent(
  `I want a Utility Diligence Pack ($479 single park).\n\nPark / market:\nSpaces / occupancy (if known):\nYour name:\nEmail:\nPhone (optional):\n\nPlease send invoice.`
)}`;

const PACK = `mailto:${email}?subject=${encodeURIComponent(
  "Utility Diligence Pack Three-Park Pack — $1,249"
)}&body=${encodeURIComponent(
  `I want a Utility Diligence Pack Three-Park Pack ($1,249).\n\nParks (up to 3):\nYour name:\nEmail:\nFirm (optional):\n\nPlease send invoice.`
)}`;

const perks = [
  {
    title: "Utility flag notes",
    body: "Water, sewer, electric, and capacity flags after reviewing the park’s utility file and recent bills.",
  },
  {
    title: "Capacity gap list",
    body: "Clear flags on capacity mismatches, missing easements, and what a lender or buyer counsel may push back on.",
  },
  {
    title: "Utility hygiene",
    body: "Line-item notes where utility docs look soft, padded, or missing for IC review.",
  },
  {
    title: "PDF delivery",
    body: "One memo PDF per park — single park at $479, or three parks in a pack at $1,249.",
  },
];
    ...
    <main className="bg-background">
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Utility Diligence Pack.
            <span className="mt-2 block text-accent">$479 · or $1,249.</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg font-light text-white/75">
            Single park at $479, or three-park pack at $1,249 — utility flag notes,
          ...
          <div className="mt-6 flex flex-wrap gap-x-4 gap-y-2 text-sm text-white/55">
            ...
            <Link href="/traffic" className="underline-offset-4 hover:text-white hover:underline">Traffic</Link>
            <Link href="/flood" className="underline-offset-4 hover:text-white hover:underline">
              Cap Rate
            </Link>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-bold text-navy md:text-4xl">
          Built for buyers and lenders who need a clean utility picture before they argue price.
        </h2>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg font-light text-foreground/70">
            Single park $479 · Three-park pack $1,249. Pair with{" "}
