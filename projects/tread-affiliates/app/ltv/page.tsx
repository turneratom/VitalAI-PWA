...
export const metadata: Metadata = {
  title: "Affiliate LTV Kit — Tread Affiliates",
  description:
    "Affiliate LTV Kit — one-time sprint $275 or monthly LTV kit $140/mo. LTV plan, LTV mix, LTV pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate LTV Kit — Tread Affiliates",
    description: "Sprint $275 · Monthly desk $140/mo. LTV plan, LTV mix, LTV pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "LTV plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day LTV kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates LTV kit — $275",
      "I want an Affiliate LTV kit ($275).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $275",
  },
  {
    tag: "Desk",
    title: "Monthly LTV kit",
    price: "$140",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly LTV kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates LTV kit — $140/mo",
      "I want a Monthly LTV kit ($140/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $140/mo",
  },
];

export default function LtvKitPage() {
  return (
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · LTV kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            LTV kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: LTV plan, LTV mix, and LTV pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly LTV kit.
        </h2>
