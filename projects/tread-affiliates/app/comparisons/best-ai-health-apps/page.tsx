...
export const metadata: Metadata = {
  title: "Best AI Health Apps (2026) — Tread Affiliates",
  description:
    "Ranked comparison of AI health apps that convert. Honest picks, clear tradeoffs, and affiliate CTAs — the Tread Affiliates monetization rail.",
  openGraph: {
    title: "Best AI Health Apps — Ranked by Tread Affiliates",
    description:
      "Which AI health tools are worth promoting? Ranked picks with direct affiliate CTAs.",
    type: "article",
  },
};
...
const picks = [
  {
    rank: 1,
    name: "VitalAI",
    tagline: "Best overall — habit loops that stick",
    verdict:
      "Clearest onboarding, strongest retention hooks, and the easiest story to sell on short-form. If you only promote one health app this quarter, make it this.",
    why: [
      "High intent avatar: people already tracking sleep / steps",
      "Free tier that converts without feeling bait-and-switch",
      "Creative angles that write themselves (before/after energy)",
    ],
    watch: "Payouts lean toward annual plans — pitch the year save, not the week trial.",
    cta: "Try VitalAI",
    href: links.affiliates.vitalai,
    accent: "signal" as const,
  },
  {
    rank: 2,
    name: "PulseKit",
    tagline: "Best for recovery & wearables",
    verdict:
      "Wins when your traffic already owns a watch. Stronger for Facebook / IG 30+ than TikTok teens. Solid second placement if VitalAI is saturated in your niche.",
    why: [
      "Pairs cleanly with Whoop / Apple Watch creatives",
      "Coach-style UX — easy to demo on camera",
      "Higher AOV than most freemium health apps",
    ],
    watch: "Slower mobile onboarding — use a loom-style walkthrough, not a cold link dump.",
    cta: "Open PulseKit",
    href: links.affiliates.pulsekit,
    accent: "cone" as const,
  },
  {
    rank: 3,
    name: "Competitor Health",
    tagline: "Budget pick — volume play",
    verdict:
      "Weaker brand, stronger CPI economics. Use when you need cheap tests or a contrast offer against VitalAI. Not your hero product — your funnel filler.",
    why: [
      "Lower barrier offers for cold traffic",
      "Useful as an A/B foil in review content",
      "Fast signup = easier TikTok Shop / CPA hybrids",
    ],
    watch: "Support and retention are soft — disclose that and lead with price.",
    cta: "See Competitor Health",
    href: links.affiliates.competitor,
    accent: "ink" as const,
  },
];

export default function BestAiHealthAppsPage() {
  return (
      ...
      <section className="hero-plane hero-grain relative overflow-hidden text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-20">
          ...
          <h1 className="animate-rise-d2 mt-4 max-w-3xl font-display text-3xl font-extrabold leading-[1.05] tracking-tight sm:text-4xl md:text-5xl">
            Best AI health apps — ranked for partners who get paid
          </h1>
          <p className="animate-rise-d3 mt-6 max-w-xl text-lg text-white/80">
            Three tools worth promoting. Clear winners, honest tradeoffs, and
            ...
            <table className="w-full min-w-[28rem] text-left text-sm">
              ...
              <tbody>
                <tr className="border-b border-line">
                  <td className="py-4 pr-4 font-display font-bold">VitalAI</td>
                ...
                <tr className="border-b border-line">
                  <td className="py-4 pr-4 font-display font-bold">PulseKit</td>
                  <td className="py-4 pr-4 text-muted">Wearables / recovery</td>
                  <td className="py-4">
                    <a
                      href={links.affiliates.pulsekit}
                      target="_blank"
                ...
                <tr>
                  <td className="py-4 pr-4 font-display font-bold">Competitor</td>
