...
export const metadata: Metadata = {
  title: "Best Calorie Tracker Apps (2026) — Tread Affiliates",
  description:
    "Ranked comparison of calorie and macro trackers that convert. Honest picks, clear tradeoffs, and affiliate CTAs — the Tread Affiliates monetization rail.",
  openGraph: {
    title: "Best Calorie Tracker Apps — Ranked by Tread Affiliates",
    description:
      "Which calorie and macro trackers are worth promoting? Ranked picks with direct affiliate CTAs.",
    type: "article",
  },
};
...
const picks = [
  {
    rank: 1,
    name: "VitalAI Macros",
    tagline: "Best overall — macros without the spreadsheet guilt",
    verdict:
      "Cleanest path from “I should track” to daily logging. Strongest habit loops for protein / deficit creatives, and the easiest house-brand story to sell on short-form. If you only promote one tracker this quarter, make it this.",
    why: [
      "High intent avatar: people already weighing food or cutting",
      "Macro-first UX that demos clean on camera",
      "Free tier that converts without feeling bait-and-switch",
    ],
    watch: "Payouts lean toward annual plans — pitch the year save, not the week trial.",
    cta: "Try VitalAI Macros",
    href: links.affiliates.macros,
    accent: "signal" as const,
  },
  {
    rank: 2,
    name: "Cronometer",
    tagline: "Best for micronutrient depth",
    verdict:
      "Wins when your traffic is nutrition-nerd or clinical-adjacent. Stronger for YouTube / Facebook 30+ than TikTok impulse. Solid second placement if VitalAI Macros is saturated in your niche.",
    why: [
      "Gold-standard food database — easy credibility angle",
      "Micronutrient story pairs with supplement funnels",
      "Higher trust for health-conscious audiences",
    ],
    watch: "UI feels denser — use a loom-style walkthrough, not a cold link dump.",
    cta: "Open Cronometer",
    href: links.affiliates.cronometer,
    accent: "cone" as const,
  },
  {
    rank: 3,
    name: "MyFitnessPal",
    tagline: "Budget / volume pick — brand everyone knows",
    verdict:
      "Weaker story differentiation, stronger brand recognition. Use when you need cheap tests, contrast offers, or cold traffic that already knows the name. Not your hero product — your funnel filler.",
    why: [
      "Instant recognition lowers click friction",
      "Useful as an A/B foil in review content",
      "Huge barcode / food log library for demo clips",
    ],
    watch: "Premium upsell fatigue is real — disclose ads/paywalls and lead with familiarity.",
    cta: "See MyFitnessPal",
    href: links.affiliates.myfitnesspal,
    accent: "ink" as const,
  },
];

export default function BestCalorieTrackerAppsPage() {
  return (
      ...
      <section className="hero-plane hero-grain relative overflow-hidden text-white">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-20">
          ...
          <h1 className="animate-rise-d2 mt-4 max-w-3xl font-display text-3xl font-extrabold leading-[1.05] tracking-tight sm:text-4xl md:text-5xl">
            Best calorie tracker apps — ranked for partners who get paid
          </h1>
          <p className="animate-rise-d3 mt-6 max-w-xl text-lg text-white/80">
            Three trackers worth promoting. Clear winners, honest tradeoffs, and
            ...
            <table className="w-full min-w-[28rem] text-left text-sm">
              ...
              <tbody>
                <tr className="border-b border-line">
                  <td className="py-4 pr-4 font-display font-bold">VitalAI Macros</td>
                  <td className="py-4 pr-4 text-muted">Overall / short-form</td>
                  <td className="py-4">
                    <a
                      href={links.affiliates.macros}
                      target="_blank"
                ...
                <tr className="border-b border-line">
                  <td className="py-4 pr-4 font-display font-bold">Cronometer</td>
                  <td className="py-4 pr-4 text-muted">Micros / depth</td>
                  <td className="py-4">
                    <a
                      href={links.affiliates.cronometer}
                      target="_blank"
                ...
                <tr>
                  <td className="py-4 pr-4 font-display font-bold">MyFitnessPal</td>
                  <td className="py-4 pr-4 text-muted">Brand / volume tests</td>
                  <td className="py-4">
                    <a
                      href={links.affiliates.myfitnesspal}
                      target="_blank"
