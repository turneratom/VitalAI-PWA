...
export const metadata: Metadata = {
  title: "Affiliate Email Sprint — Tread Affiliates",
  description:
    "Affiliate Email Sprint — one-time sprint $2,400 or monthly Email desk $950/mo. Funnel audit, page tests, CTA rewrite plan. Invoice by email.",
  openGraph: {
    title: "Affiliate Email Sprint — Tread Affiliates",
    description: "Sprint $2,400 · Monthly desk $950/mo. Funnel audit, page tests, CTA rewrite plan.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Lifecycle map across your primary rails",
      "Welcome / nurture / winback sequence briefs",
      "Subject and offer rewrite notes",
      "30-day email execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Email sprint — $2,400",
      "I want an Affiliate Email sprint ($2,400).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $2,400",
  },
  {
    tag: "Desk",
    title: "Monthly Email desk",
    price: "$950",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly send and conversion review",
      "Two new flows or campaign briefs per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Email desk — $950/mo",
      "I want a Monthly Email desk ($950/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Email</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Email that lifts comparison-rail conversions — not vanity opens.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: lifecycle map, sequence briefs, and subject rewrite notes.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Email desk.
        </h2>
      ...
      <section className="border-t border-line bg-ink text-white">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 py-12 md:flex-row md:items-center md:justify-between md:px-8">
          ...
          <a href="mailto:brad@treadcompanies.com?subject=Tread%20Affiliates%20Email" className="inline-flex rounded-sm bg-signal px-5 py-3 text-sm font-bold uppercase tracking-wider text-ink transition hover:bg-white">
