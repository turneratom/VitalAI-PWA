...
export const metadata: Metadata = {
  title: "Affiliate Yield Kit — Tread Affiliates",
  description:
    "Affiliate Yield Kit — one-time sprint $185 or monthly Yield kit $95/mo. Yield plan, Yield mix, Yield pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Yield Kit — Tread Affiliates",
    description: "Sprint $185 · Monthly desk $95/mo. Yield plan, Yield mix, Yield pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    yield: " one-time",
    points: [
      "Yield plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Yield kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Yield kit — $185",
      "I want an Affiliate Yield kit ($185).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $185",
  },
  {
    tag: "Desk",
    title: "Monthly Yield kit",
    price: "$95",
    yield: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Yield kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Yield kit — $95/mo",
      "I want a Monthly Yield kit ($95/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $95/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Yield kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Yield kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: Yield plan, Yield mix, and Yield pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Yield kit.
        </h2>
          ...
          {packages.map((pkg) => (
            <article key={pkg.title} className="flex flex-col border border-line bg-white p-8 shadow-[0_12px_40px_rgba(15,23,42,0.06)]">
              ...
              <p className="mt-2 text-3xl font-extrabold text-ink">
                {pkg.price}
                <span className="text-base font-semibold text-ink/50">{pkg.yield}</span>
              </p>
