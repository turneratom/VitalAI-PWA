...
export const metadata: Metadata = {
  title: "Affiliate Cross-Sell Kit — Tread Affiliates",
  description:
    "Affiliate Cross-Sell Kit — one-time sprint $1,000 or monthly Cross-sell kit $395/mo. Cross-sell plan, bundle mix, bundle pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Cross-Sell Kit — Tread Affiliates",
    description: "Sprint $1,000 · Monthly desk $395/mo. Cross-sell plan, bundle mix, bundle pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    tag: "Sprint",
    title: "Cross-sell kit",
    price: "$1,000",
    cadence: " one-time",
    points: [
      "Cross-sell plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Cross-sell kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Cross-sell kit — $1,000",
      "I want an Affiliate Cross-sell kit ($1,000).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $1,000",
  },
  {
    tag: "Desk",
    title: "Monthly Cross-sell kit",
    price: "$395",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Cross-sell kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Cross-sell kit — $395/mo",
      "I want a Monthly Cross-sell kit ($395/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $395/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Cross-sell kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Cross-sell kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: cross-sell plan, bundle mix, and bundle pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Cross-sell kit.
        </h2>
