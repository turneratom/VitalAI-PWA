...
export const metadata: Metadata = {
  title: "Affiliate Withhold Kit — Tread Affiliates",
  description:
    "Affiliate Withhold Kit — one-time sprint $35 or monthly Withhold kit $15/mo. Withhold plan, Withhold mix, Withhold pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Withhold Kit — Tread Affiliates",
    description: "Sprint $35 · Monthly desk $15/mo. Withhold plan, Withhold mix, Withhold pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    period: " one-time",
    points: [
      "Withhold plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Withhold kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Withhold kit — $35",
      "I want an Affiliate Withhold kit ($35).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $35",
  },
  {
    tag: "Desk",
    title: "Monthly Withhold kit",
    price: "$15",
    period: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Withhold kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Withhold kit — $15/mo",
      "I want a Monthly Withhold kit ($15/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $15/mo",
  },
];

export default function WithholdPage() {
  return (
      ...
      <header className="border-b border-line bg-ink text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 md:px-8">
          ...
          <nav className="flex flex-wrap items-center gap-4 text-sm text-white/70">
            ...
            <Link href="/withhold" className="transition hover:text-signal">Withhold kit</Link>
...
<Link href="/apportionment" className="transition hover:text-signal">Apportionment kit</Link>
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Withhold kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Withhold kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: Withhold plan, Withhold mix, and Withhold pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Withhold kit.
        </h2>
