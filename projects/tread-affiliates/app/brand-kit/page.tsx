...
export const metadata: Metadata = {
  title: "Affiliate Brand Kit — Tread Affiliates",
  description:
    "Affiliate Brand Kit — one-time sprint $1,700 or monthly Brand kit $650/mo. Brand plan, brand mix, brand pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Brand Kit — Tread Affiliates",
    description: "Sprint $1,700 · Monthly desk $650/mo. Brand plan, brand mix, brand pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Brand plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Brand kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Brand kit — $1,700",
      "I want an Affiliate Brand kit ($1,700).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $1,700",
  },
  {
    tag: "Desk",
    title: "Monthly Brand kit",
    price: "$650",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Brand kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Brand kit — $650/mo",
      "I want a Monthly Brand kit ($650/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $650/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Brand kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Brand kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: brand-kit plan, brand mix, and brand pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Brand kit.
        </h2>
