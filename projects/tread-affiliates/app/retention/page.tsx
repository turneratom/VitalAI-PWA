...
export const metadata: Metadata = {
  title: "Affiliate Retention Kit — Tread Affiliates",
  description:
    "Affiliate Retention Kit — one-time sprint $325 or monthly Retention kit $165/mo. Retention plan, retention mix, retention pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Retention Kit — Tread Affiliates",
    description: "Sprint $325 · Monthly desk $165/mo. Retention plan, retention mix, retention pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Retention plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Retention kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Retention kit — $325",
      "I want an Affiliate Retention kit ($325).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $325",
  },
  {
    tag: "Desk",
    title: "Monthly Retention kit",
    price: "$165",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Retention kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Retention kit — $165/mo",
      "I want a Monthly Retention kit ($165/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $165/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      <header className="border-b border-line bg-ink text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 md:px-8">
          ...
          <nav className="flex flex-wrap items-center gap-4 text-sm text-white/70">
            ...
            <Link href="/retention" className="transition hover:text-signal">Retention kit</Link>
            <a href="#packages" className="rounded-sm bg-signal px-3 py-1.5 font-semibold text-ink transition hover:bg-white">Retention kit</a>
          </nav>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Retention kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Retention kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: retention plan, retention mix, and retention pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Retention kit.
        </h2>
