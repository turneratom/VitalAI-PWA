...
export const metadata: Metadata = {
  title: "Affiliate Transfer Kit — Tread Affiliates",
  description:
    "Affiliate Transfer Kit — one-time sprint $8 or monthly Transfer kit $1/mo. Transfer plan, Transfer mix, Transfer pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Transfer Kit — Tread Affiliates",
    description: "Sprint $8 · Monthly desk $1/mo. Transfer plan, Transfer mix, Transfer pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    period: " one-time",
    points: [
      "Transfer plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Transfer kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Transfer kit — $8",
      "I want an Affiliate Transfer kit ($8).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $8",
  },
  {
    tag: "Desk",
    title: "Monthly Transfer kit",
    price: "$1",
    period: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Transfer kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Transfer kit — $1/mo",
      "I want a Monthly Transfer kit ($1/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
...
<Link href="/wire" className="transition hover:text-signal">Wire kit</Link>
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Transfer kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Transfer kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: Transfer plan, Transfer mix, and Transfer pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Transfer kit.
        </h2>
