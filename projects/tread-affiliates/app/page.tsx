      ...
      <header className="absolute inset-x-0 top-0 z-20">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 md:px-8">
          ...
          <nav className="hidden items-center gap-6 text-sm text-white/70 sm:flex">
            ...
            <a href="/shorts" className="transition hover:text-signal">
              Shorts
            </a>
            ...
            <a href="/rebate" className="transition hover:text-signal">
              Rebate
            </a>
            <a href="/holdback" className="transition hover:text-signal">
              Holdback
            </a>
            <a href="/clawback" className="transition hover:text-signal">
              Clawback
            </a>
            ...
            <a href="/reconciliation" className="transition hover:text-signal">
              Reconciliation
            </a>
            ...
            <a href="/distribution" className="transition hover:text-signal">
              Distribution
            </a>
            <a href="/disbursement" className="transition hover:text-signal">
              Disbursement
            </a>
            ...
            <a href="/fast-pay" className="transition hover:text-signal">
              Fast-Pay
            </a>
            <a href="/express-pay" className="transition hover:text-signal">
              Express-Pay
            </a>
            <a href="/zelle" className="transition hover:text-signal">
              Zelle
            </a>
