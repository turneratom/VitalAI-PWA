...
export const metadata: Metadata = {
  title: "Affiliate Catalog Desk — Tread Affiliates",
  description:
    "Affiliate Catalog Desk — one-time sprint $3,200 or monthly Catalog desk $1,250/mo. Catalog plan, assortment mix, creative pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Catalog Desk — Tread Affiliates",
    description: "Sprint $3,200 · Monthly desk $1,250/mo. Catalog plan, assortment mix, creative pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Catalog plan across your primary rails",
      "Assortment mix and SKU bands for primary funnels",
      "Creative-to-SKU pairing notes",
      "30-day catalog execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Catalog desk — $3,200",
      "I want an Affiliate Catalog desk ($3,200).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $3,200",
  },
  {
    tag: "Desk",
    title: "Monthly Catalog desk",
    price: "$1,250",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly catalog and ROAS review",
      "Two new SKU or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Catalog desk — $1,250/mo",
      "I want a Monthly Catalog desk ($1,250/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $1,250/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      <header className="border-b border-line bg-ink text-white">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-5 md:px-8">
          ...
          <nav className="flex flex-wrap items-center gap-4 text-sm text-white/70">
            ...
            <a href="#packages" className="rounded-sm bg-signal px-3 py-1.5 font-semibold text-ink transition hover:bg-white">Catalog</a>
          </nav>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Catalog</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Catalog builds that convert comparison-rail traffic — not link dumps.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: catalog plan, assortment mix, and creative pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Catalog desk.
        </h2>
