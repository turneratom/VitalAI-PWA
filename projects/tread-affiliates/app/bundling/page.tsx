...
export const metadata: Metadata = {
  title: "Affiliate Bundle Desk — Tread Affiliates",
  description:
    "Affiliate Bundle Desk — one-time sprint $2,600 or monthly Bundle desk $1,000/mo. Bundle plan, offer mix, creative pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Bundle Desk — Tread Affiliates",
    description: "Sprint $2,600 · Monthly desk $1,000/mo. Bundle plan, offer mix, creative pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Bundle plan across your primary rails",
      "Offer mix and stack bands for primary funnels",
      "Creative-to-offer pairing notes",
      "30-day bundle execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Bundle desk — $2,600",
      "I want an Affiliate Bundle desk ($2,600).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $2,600",
  },
  {
    tag: "Desk",
    title: "Monthly Bundle desk",
    price: "$1,000",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly bundle and ROAS review",
      "Two new stack or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Bundle desk — $1,000/mo",
      "I want a Monthly Bundle desk ($1,000/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $1,000/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Bundling</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Bundle builds that convert comparison-rail traffic — not random stacks.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: bundle plan, offer mix, and creative pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Bundle desk.
        </h2>
