...
export const metadata: Metadata = {
  title: "Affiliate Nurture Kit — Tread Affiliates",
  description:
    "Affiliate Nurture Kit — one-time sprint $500 or monthly Nurture kit $245/mo. Nurture plan, drip mix, drip pairing. Invoice by email.",
  openGraph: {
    title: "Affiliate Nurture Kit — Tread Affiliates",
    description: "Sprint $500 · Monthly desk $245/mo. Nurture plan, drip mix, drip pairing.",
    type: "website",
  },
};
...
const packages = [
  {
    ...
    cadence: " one-time",
    points: [
      "Nurture plan across your primary rails",
      "Creator mix and post bands for primary funnels",
      "Creative-to-creator pairing notes",
      "30-day Nurture kit execution checklist",
    ],
    href: MAIL(
      "Tread Affiliates Nurture kit — $500",
      "I want an Affiliate Nurture kit ($500).\n\nBrand / site:\nPrimary rails:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request sprint — $500",
  },
  {
    tag: "Desk",
    title: "Monthly Nurture kit",
    price: "$245",
    cadence: "/mo",
    points: [
      "Everything in the sprint, ongoing",
      "Monthly Nurture kit and ROAS review",
      "Two new creator or creative swaps per month",
      "Priority Slack/email desk",
    ],
    href: MAIL(
      "Tread Affiliates Nurture kit — $245/mo",
      "I want a Monthly Nurture kit ($245/mo).\n\nBrand / site:\nPrimary rails:\nPreferred start:\nName:\nEmail:\n\nPlease send invoice."
    ),
    cta: "Request desk — $245/mo",
  },
];
    ...
    <div className="min-h-screen bg-paper text-ink">
      ...
      <section className="relative overflow-hidden bg-ink text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-5 pb-16 pt-16 md:px-8 md:pb-20 md:pt-24">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-signal">Tread Affiliates · Nurture kit</p>
          <h1 className="mt-5 max-w-3xl font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Nurture kit packages that convert comparison-rail traffic — not vanity posts.
          </h1>
          <p className="mt-6 max-w-2xl text-lg text-white/75">
            One-time sprint or monthly desk: nurture plan, drip mix, and drip pairing.
      ...
      <section id="packages" className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-extrabold tracking-tight md:text-4xl">
          Sprint once, or keep a monthly Nurture kit.
        </h2>
