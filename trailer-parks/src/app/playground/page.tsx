...
export const metadata: Metadata = {
  title: "Playground Diligence Pack — $249 | Trailer Parks",
  description:
    "Playground Diligence Pack: single park $249, or three-park pack $399. Playground flag notes, variance gap list, lender-ready summary. Invoice by email.",
  openGraph: {
    title: "Playground Diligence Pack — $249",
    description:
      "Single park $249 · Three-park pack $399. Playground flag notes, variance gap list, lender-ready summary.",
    type: "website",
...
const SINGLE = `mailto:${email}?subject=${encodeURIComponent(
  "Playground Diligence Pack — $249 single park"
)}&body=${encodeURIComponent(
  `I want a Playground Diligence Pack ($249 single park).\n\nPark / market:\nSpaces / occupancy (if known):\nYour name:\nEmail:\nPhone (optional):\n\nPsurfacing send invoice.`
)}`;

const PACK = `mailto:${email}?subject=${encodeURIComponent(
  "Playground Diligence Pack Three-Park Pack — $399"
)}&body=${encodeURIComponent(
  `I want a Playground Diligence Pack Three-Park Pack ($399).\n\nParks (up to 3):\nYour name:\nEmail:\nFirm (optional):\n\nPsurfacing send invoice.`
)}`;

const perks = [
  {
    title: "Playground flag notes",
    body: "Equipment, surfacing, and compliance flags after reviewing the park’s playground file and recent tests.",
  },
  {
    title: "Equipment gap list",
    body: "Clear flags on equipment mismatches, missing tests, and what a lender or buyer counsel may push back on.",
  },
  {
    title: "Playground hygiene",
    body: "Line-item notes where playground docs look soft, padded, or missing for IC review.",
  },
  {
    title: "PDF delivery",
    body: "One memo PDF per park — single park at $249, or three parks in a pack at $399.",
  },
];
    ...
    <main className="bg-background">
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Playground Diligence Pack.
            <span className="mt-2 block text-accent">$249 · or $399.</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg font-light text-white/75">
            Single park at $249, or three-park pack at $399 — playground flag notes,
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-bold text-navy md:text-4xl">
          Built for buyers and lenders who need a clean playground picture before they argue price.
        </h2>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg font-light text-foreground/70">
            Single park $249 · Three-park pack $399. Pair with{" "}
