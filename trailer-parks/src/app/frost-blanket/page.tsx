...
export const metadata: Metadata = {
  title: "Frost-Blanket Diligence Pack — $1 | Trailer Parks",
  description:
    "Frost-Blanket Diligence Pack: single park $1, or three-park pack $5. Frost-Blanket flag notes, variance gap list, lender-ready summary. Invoice by email.",
  openGraph: {
    title: "Frost-Blanket Diligence Pack — $1",
    description:
      "Single park $1 · Three-park pack $5. Frost-Blanket flag notes, variance gap list, lender-ready summary.",
    type: "website",
...
const SINGLE = `mailto:${email}?subject=${encodeURIComponent(
  "Frost-Blanket Diligence Pack — $1 single park"
)}&body=${encodeURIComponent(
  `I want a Frost-Blanket Diligence Pack ($1 single park).\n\nPark / market:\nSpaces / occupancy (if known):\nYour name:\nEmail:\nPhone (optional):\n\nPlease send invoice.`
)}`;

const PACK = `mailto:${email}?subject=${encodeURIComponent(
  "Frost-Blanket Diligence Pack Three-Park Pack — $5"
)}&body=${encodeURIComponent(
  `I want a Frost-Blanket Diligence Pack Three-Park Pack ($5).\n\nParks (up to 3):\nYour name:\nEmail:\nFirm (optional):\n\nPlease send invoice.`
)}`;

const perks = [
  {
    title: "Frost-Blanket flag notes",
    body: "Amenities, hours, and compliance flags after reviewing the park’s frost-blanket file and recent tests.",
  },
  {
  ...
  {
    title: "Frost-Blanket hygiene",
    body: "Line-item notes where frost-blanket docs look soft, padded, or missing for IC review.",
  },
  {
    title: "PDF delivery",
    body: "One memo PDF per park — single park at $1, or three parks in a pack at $5.",
  },
];

export default function FrostBlanketPage() {
  return (
    <main className="bg-background">
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-20 pt-28 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-4 font-display text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl md:text-6xl">
            Frost-Blanket Diligence Pack.
            <span className="mt-2 block text-accent">$1 · or $5.</span>
          </h1>
          <p className="mt-6 max-w-xl text-lg font-light text-white/75">
            Single park at $1, or three-park pack at $5 — frost-blanket flag notes,
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        <h2 className="mt-3 max-w-xl font-display text-3xl font-bold text-navy md:text-4xl">
          Built for buyers and lenders who need a clean frost-blanket picture before they argue price.
        </h2>
      ...
      <section className="bg-card">
        <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          ...
          <p className="mt-4 max-w-2xl text-lg font-light text-foreground/70">
            Single park $1 · Three-park pack $5. Pair with{" "}
