...
- Turner Capital: `fx.html` — FX Overlay Memo **$2,100** · **$1,050/mo**.
- Turner Biographies: `/serial-print` — Serial Print Rights **$9,000** · **$24,000**.
- Tread Affiliates: `/media` — Affiliate Media Desk **$4,500** · **$1,800/mo**.
- Deploy: keep Vercel `ignoreCommand: exit 0` while hobby rate-limited; GHA remains the green gate.
- Prior: helicopter/event/stress/epa; credit/reprint/tracking.
